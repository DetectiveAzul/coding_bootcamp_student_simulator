...
public enum CardCollection {
    ...
    M1_11(1,Person.FLATMATE, R.string.m1c11_name , R.string.m1c11_description,
            ...
            new StatEffect[] {StatEffect.MONEY_NEGATIVE},
            new StatEffect[] {StatEffect.MONEY_NEGATIVE}),
    M1_12(1,Person.TEACHER, R.string.m1c12_name , R.string.m1c12_description,
    ...
    M1_13(1,Person.STUDENT, R.string.m1c13_name , R.string.m1c13_description,
            ...
            new StatEffect[] {StatEffect.ANXIETY_NEGATIVE, StatEffect.SLEEP_POSITIVE, StatEffect.SOCIAL_NEGATIVE}),
    M1_14(1,Person.TEACHER, R.string.m1c14_name , R.string.m1c14_description,
            R.string.m1c14_first_option, R.string.m1c14_second_option,
            Difficult.MEDIUM,
            new StatEffect[] {StatEffect.ANXIETY_NEGATIVE},
            new StatEffect[] {StatEffect.ANXIETY_NEGATIVE, StatEffect.SLEEP_NEGATIVE}),
    M1_15(1,Person.STUDENT, R.string.m1c15_name , R.string.m1c15_description,
            R.string.m1c15_first_option, R.string.m1c15_second_option,
            Difficult.MEDIUM,
            new StatEffect[] {StatEffect.SOCIAL_NEGATIVE, StatEffect.MONEY_POSITIVE},
            new StatEffect[] {StatEffect.SOCIAL_POSITIVE, StatEffect.MONEY_NEGATIVE}),
    M1_16(1,Person.TEACHER, R.string.m1c16_name , R.string.m1c16_description,
            R.string.m1c16_first_option, R.string.m1c16_second_option,
            Difficult.EASY,
            new StatEffect[] {StatEffect.SLEEP_POSITIVE, StatEffect.ANXIETY_POSITIVE},
            new StatEffect[] {StatEffect.SLEEP_NEGATIVE, StatEffect.ANXIETY_POSITIVE}),
    M1_17(1,Person.STUDENT, R.string.m1c17_name , R.string.m1c17_description,
            ...
            Difficult.EASY,
            new StatEffect[] {StatEffect.ANXIETY_NEGATIVE},
            new StatEffect[] {StatEffect.ANXIETY_NEGATIVE, StatEffect.SOCIAL_POSITIVE, StatEffect.MONEY_NEGATIVE}),
    M1_18(1,Person.TEACHER, R.string.m1c18_name , R.string.m1c18_description,
            R.string.m1c18_first_option, R.string.m1c18_second_option,
            Difficult.MEDIUM,
            new StatEffect[] {StatEffect.SLEEP_POSITIVE, StatEffect.ANXIETY_NEGATIVE, StatEffect.SOCIAL_NEGATIVE},
            new StatEffect[] {StatEffect.SLEEP_POSITIVE, StatEffect.ANXIETY_POSITIVE, StatEffect.MONEY_NEGATIVE, StatEffect.SOCIAL_NEGATIVE}),
    M1_19(1,Person.TEACHER, R.string.m1c19_name , R.string.m1c19_description,
